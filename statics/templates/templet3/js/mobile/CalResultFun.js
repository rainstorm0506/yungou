        ...
        if (l.code == 0) {		 
		  if(l.contcode==0){
            ...
            k += '<div class="infoCount"><div class="infoCount2"><ul><li style="border:0 none;">取以上数值结果得：</li><li>1、求和：' + r + "<em>(上面100条云购记录时间取值相加之和)</em></li><li><p>2、取余：" + r + "<em>(100条时间记录之和)</em><br/>%" + j + "<em>(本商品总需参与人次)</em>=" + p + "<em>(余数)</em></p></li><li>3、计算结果：" + p + "<em>(余数)</em>+10000001=<span>" + q + "</span></p>" + (q != n ? '<li><p style="text-indent:-6.6em; padding-left:80px;">4、最终结果：' + q + " 未被购买，取差值最小的云购码 " + n + " 为幸运云购码</p></li>": "") + "</div></div>";
				...
				var n = $("#hidCodeRno").val(); 
				var q = parseInt(p) + parseInt("10000001");
				var k = '<div class="infoCount"><div class="infoCount2"><ul><li style="text-align:center;border:0 none;">未满100条计算结果</li><li ">取以上数值结果得：</li><li>1、求和：' + r + "<em>(上面100条云购记录时间取值相加之和)</em></li><li><p>2、取余：" + r + "<em>(100条时间记录之和)</em><br/>%" + j + "<em>(本商品总需参与人次)</em>=" + p + "<em>(余数)</em></p></li><li>3、计算结果：" + p + "<em>(余数)</em>+10000001=<span>" + q + "</span></p>" + (q != n ? '<li><p style="text-indent:-6.6em; padding-left:80px;">4、最终结果：' + q + " 未被购买，取差值最小的云购码 " + n + " 为幸运云购码</p></li>": "") + "</div></div>";
