               ...
               // GetJPData("http://m.1yyg.com", "getUserOrderList", j(),
                ...
                function(p) {				 
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {						 
                            m += "<li onclick=\"location.href='"+Gobal.Webpath+"/mobile/user/buyDetail/" + o[l].id +'\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + o[l].thumb + '" border=0 alt=""/></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="'+Gobal.Webpath+'mobile/mobile/item/' + o[l].id +'" class="gray6">(第' + o[l].qishu + "期)" + o[l].title + '</a></p><p>幸运云购码：<em class="orange">' + o[l].q_user_code + "</em></p><p>揭晓时间：" + o[l].q_end_time + "</p>";
