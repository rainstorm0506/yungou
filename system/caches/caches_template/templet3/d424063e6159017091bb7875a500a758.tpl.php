...
<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_STYLE; ?>/css/layout-invitation.css"/>
            ...
            <div class="total">
        	    <dt>
            	    </dt><dd>累计收入：<b class="orange"><?php echo $shourutotal; ?></b>元</dd>  <dd>累计(提现/充值)：<b class="orange"><?php echo $zhichutotal; ?></b>元</dd> <dd>佣金余额：<b class="orange"><?php echo $total; ?></b>元</dd><dd><a href="<?php echo WEB_PATH; ?>/member/home/cashout" title="申请提现" class="bluebut">申请提现</a><a href="<?php echo WEB_PATH; ?>/member/home/cashout" title="充值到云购账户" class="orangebut">充值到云购账户</a></dd>
