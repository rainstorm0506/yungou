		...
		<div class="upRight">
			...
			<div class="photo gray02">
				<ul>
					...
					<li class="li160"><div class="w160"><div id="w160"><img id="crop_preview" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_160160.jpg" width="160" height="160"  /></div></div>160X160 像素</li>
					<li class="li80"><div class="w80"><div id="w80"><img id="crop_preview2" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_8080.jpg" width="80" height="80"  /></div></div>80X80 像素</li>
					<li class="li30"><div class="w30"><div id="w30"><img id="crop_preview3" src="<?php echo G_UPLOAD_PATH; ?>/photo/member.jpg_3030.jpg" width="30" height="30"  /></div></div>30X30 像素</li>					
					<?php  else: ?>			
