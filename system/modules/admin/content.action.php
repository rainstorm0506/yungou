...
HTML;
    ...
    public function goods_edit() {
        ...
        //获取到“云购产品类型”
        $goods_types = $this->db->GetList("SELECT * FROM `@#_goods_type`");
        //获取到“分区云购产品的分区”
        $goods_area = $this->db->GetList("SELECT * FROM `@#_goods_area`");
    ...
    public function goods_add() {
        ...
        if (isset($_POST['dosubmit'])) {
            ...
            $query_1 = $this->db->Query("INSERT INTO `@#_shoplist` (`cateid`, `brandid`,`goods_type`,`area_id`, `title`, `title_style`, `title2`, `keywords`, `description`, `money`, `yunjiage`, `zongrenshu`, `canyurenshu`,`shenyurenshu`, `qishu`,`maxqishu`,`thumb`, `picarr`, `content`,`xsjx_time`,`renqi`,`pos`, `time`) VALUES ('$cateid', '$brandid','$goods_type','$area_id', '$title', '$title_style', '$title2', '$keywords', '$description', '$money', '$yunjiage', '$zongrenshu', '$canyurenshu','$shenyurenshu', '1','$maxqishu', '$thumb', '$picarr', '$content','$xsjx_time','$goods_key_renqi', '$goods_key_pos','$time')");
