            ...
            <link rel="stylesheet" href="<?php echo G_GLOBAL_STYLE; ?>/global/css/style.css" type="text/css">
                ...
                <link rel="stylesheet" href="<?php echo G_PLUGIN_PATH; ?>/calendar/calendar-blue.css" type="text/css"> 
                    ...
                    <script type="text/javascript">
                        ...
                        $(function(){
                            $("#area").hide();
                            //当点击 单选框“分区云购”时候，要展示分区
                            $("#type_3").click(function(){
                                $("#area").show();
                            });
                            //点击其他 单选“分区云购”的时候，要隐藏分区
                                ...
                                <table width="100%"  cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="radio" id="type_<?php echo $type['id'];?>" name="goods_type" value="<?php echo $type['id'];?>" <?php if($type['id']==1) echo "checked='checked'";?>>
                                    ...
                                    <tr id="area">
                                        ...
                                        <td>
                                            <select name="area_id">
                                                ...
                                                <option value="<?php echo $goods['id'];?>"><?php echo $goods['area_name'];?></option>
                                                <?php endforeach;?>
                                            </select>
                                        </td>
                                    </tr>                                    
