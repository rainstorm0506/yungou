...
<div id="left">
    <ul class="left_date" id="setting">   
     ...
     <ul class="left_date" id="shop">   
        ...
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_add">添加普通商品</a></li>
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/local_goods_add">添加本地生活云购商品</a></li>
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/area_goods_add">添加分区云购商品</a></li>
